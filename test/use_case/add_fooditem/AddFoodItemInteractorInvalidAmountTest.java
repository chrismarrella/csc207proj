...
public class AddFoodItemInteractorInvalidAmountTest {
    ...
    @Test
    public void execute_shouldReturnError_whenAmountIsInvalid() {
        AddFoodItemInputData addFoodItemInputData = new AddFoodItemInputData("Banana", "2024", "1", "1", "a");
        addFoodItemInteractor.execute(addFoodItemInputData);
        assertEquals("Amount is invalid!", addFoodItemViewModel.getState().getAmountError());
    }
}
