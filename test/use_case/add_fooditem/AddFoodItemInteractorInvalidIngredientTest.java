...
public class AddFoodItemInteractorInvalidIngredientTest {
    ...
    @Test
    public void execute_shouldReturnError_whenIngredientIsInvalid() {
        AddFoodItemInputData addFoodItemInputData = new AddFoodItemInputData("", "2024", "1", "1", "1");
